		...
		>
			<Select.Viewport class="flex flex-col gap-1 p-1">
				{#each items as item, i (i + item.value)}
					<Select.Item
						class={[
							'outline-hidden  data-disabled:opacity-50 data-highlighted:bg-gray-100 flex h-10 w-full select-none items-center rounded-md px-3 py-1.5 text-sm capitalize',
