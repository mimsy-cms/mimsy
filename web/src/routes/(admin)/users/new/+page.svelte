...
<div class="flex flex-col gap-6 p-6" style="max-width: calc(100vw - 280px - 48px);">
	...
	<div class="flex justify-end gap-2">
		<button
			...
			class="flex items-center rounded-md border border-gray-300 px-2 py-1 text-gray-700 hover:bg-gray-100"
		>
			<UndoIcon class="mr-3 h-5 w-5 flex-shrink-0" />
			Cancel
		</button>
		<button type="submit" form="createUserForm" class="btn flex items-center">
			<SaveIcon class="mr-3 h-5 w-5 flex-shrink-0" />
			Save
		</button>
	</div>

	<div class="w-full rounded-md border border-gray-300 bg-white p-6">
