...
//
//	mockgen -source=internal/auth/repository.go -destination=internal/mocks/auth/mock_repository.go -package=mocks AuthRepository
//
...
func (mr *MockAuthRepositoryMockRecorder) CountUsers(ctx any) *gomock.Call {
...
func (mr *MockAuthRepositoryMockRecorder) CreateSession(ctx, token, userID, expiresAt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) DeleteExpiredSessions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) DeleteSession(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) GetUserBySessionToken(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) GetUserPassword(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAuthRepository) GetUsers(ctx context.Context) ([]auth.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) GetUsers(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUsers", reflect.TypeOf((*MockAuthRepository)(nil).GetUsers), ctx)
}
...
func (mr *MockAuthRepositoryMockRecorder) InsertUser(ctx, email, password, isAdmin, mustChange any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) UpdatePassword(ctx, userID, newHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepositoryMockRecorder) UserExists(ctx, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
