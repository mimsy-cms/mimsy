...
func (m *MockAuthRepository) GetUserByEmail(ctx context.Context, email string) (*auth_interface.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByEmail", ctx, email)
	ret0, _ := ret[0].(*auth_interface.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAuthRepository) GetUserBySessionToken(ctx context.Context, token string) (*auth_interface.User, error) {
	m.ctrl.T.Helper()
