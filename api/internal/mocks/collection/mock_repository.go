...
func (mr *MockRepositoryMockRecorder) CreateCollection(ctx, slug, name, fieldsJson any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) CreateResource(ctx context.Context, arg1 *collection.Collection, resourceSlug string, createdBy int64) (*collection.Resource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) CreateResource(ctx, arg1, resourceSlug, createdBy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateResource", reflect.TypeOf((*MockRepository)(nil).CreateResource), ctx, arg1, resourceSlug, createdBy)
}
