...
func (mr *MockSyncStatusRepositoryMockRecorder) CreateIfNotExists(ctx, repo, commitSha, commitMessage, commitDate interface{}) *gomock.Call {
...
func (mr *MockSyncStatusRepositoryMockRecorder) GetActiveMigration(ctx, repo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) GetLastSyncedCommit(ctx, repo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) GetRecentStatuses(ctx, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) GetStatus(ctx, repo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) MarkAsActive(ctx, repo, commitSha interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) MarkAsSkipped(ctx, repo, commitSha interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) MarkError(ctx, repo, commitSha, err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) SetAppliedMigration(ctx, repo, commitSha, migration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncStatusRepositoryMockRecorder) SetManifest(ctx, repo, commitSha, manifest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
